...
// Use global fetch available in Node 18+; fallback to globalThis.fetch
...
router.post('/signup', async (req, res) => {
  ...
  try {
    if (country) {
      const r = await (fetchFn || fetch)(`https://restcountries.com/v3.1/name/${encodeURIComponent(country)}?fields=currencies`);
